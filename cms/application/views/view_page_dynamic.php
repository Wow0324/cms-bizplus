    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="inner">
                    <div class="text">
                        <h1><?php echo safe_data($page_dynamic_detail['name']); ?></h1>
                        <div class="breadcrumb-container d-flex justify-content-center">
                            <nav>
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page"><?php echo safe_data($page_dynamic_detail['name']); ?></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-md-12 xs_mt_30 sm_mt_30">
                <div class="text page-title">
                    <?php echo safe_data($page_dynamic_detail['content']); ?>
                </div>
            </div>
        </div>
    </div>
