			...
			<div class="nav-tabs-custom">
				...
				<div class="tab-content">
      				...
      				<div class="tab-pane active" id="tab_1">						
						<?php echo form_open(base_url().M_REWRITE.'admin/profile/update',array('class' => 'form-horizontal')); ?>
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group">
									<label for="" class="col-sm-2 control-label">Email Address <span>*</span></label>
									<div class="col-sm-4">
										<input type="text" class="form-control" name="email" value="<?php echo safe_data($this->session->userdata('email')); ?>">
									</div>			
								</div>
								<div class="form-group">
									<label for="" class="col-sm-2 control-label">Role <span>*</span></label>
									<div class="col-sm-4 pt_7">
										<?php echo safe_data($this->session->userdata('role')); ?>
									</div>
								</div>
								<div class="form-group">
      				...
      				<div class="tab-pane" id="tab_2">
						<?php echo form_open_multipart(base_url().M_REWRITE.'admin/profile/update',array('class' => 'form-horizontal')); ?>
						<div class="box box-info">
							<div class="box-body">
								<div class="form-group">
						            ...
						            <div class="col-sm-6 pt_5">
						            	...
						            	<?php else: ?>
						            		 <img src="<?php echo base_url(); ?>public/uploads/<?php echo safe_data($this->session->userdata('photo')); ?>" class="existing-photo" width="140">
						            	<?php endif; ?>							                
						            </div>
						        </div>
								<div class="form-group">
