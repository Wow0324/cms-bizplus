...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg">Please reset your password from below</h4>
		...
		<?php echo form_open(base_url().M_REWRITE.'admin/reset-password/index/'.$var1.'/'.$var2);?>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="New Password" name="new_password" type="password" autocomplete="off" required autofocus>
			</div>
			<div class="form-group has-feedback">
				<input class="form-control" placeholder="Retype Password" name="re_password" type="password" autocomplete="off" required autofocus>
			</div>
			<div class="row">
				<div class="col-xs-8 pt_7"></div>
				<div class="col-xs-4">
