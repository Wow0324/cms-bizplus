...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open_multipart(base_url().M_REWRITE.'admin/category/add',array('class' => 'form-horizontal')); ?>
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" autocomplete="off" class="form-control" name="category_slug" value="">
							</div>
						</div>
						<div class="form-group">
