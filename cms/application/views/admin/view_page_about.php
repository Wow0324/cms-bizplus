            ...
            <tbody>
            	...
            	foreach ($page_about as $row) {
					...
					<tr>
	                    ...
	                    <td><?php echo safe_data($row['about_heading']); ?></td>
                        <td><?php echo safe_data($row['lang_name']); ?></td>
	                    <td>
	                        <a href="<?php echo base_url().M_REWRITE; ?>admin/page-about/edit/<?php echo safe_data($row['id']); ?>" class="btn btn-primary btn-xs">Edit</a>
	                    </td>
	                </tr>
            		<?php
            	}
