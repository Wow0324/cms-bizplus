...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url().M_REWRITE; ?>admin/subscriber" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	...
	<div class="row">
		<div class="col-md-12">
			...
			<?php echo form_open(base_url().M_REWRITE.'admin/subscriber/send_email',array('class' => 'form-horizontal')); ?>
