...
<div class="login-box">
	<div class="login-logo">
  	...
  	<div class="login-box-body">
    	<h4 class="login-box-msg">Login through the form below</h4>
		...
		<?php echo form_open(base_url().M_REWRITE.'admin'); ?>
			...
			<div class="row">
				<div class="col-xs-8 pt_7"><a href="<?php echo base_url().M_REWRITE; ?>admin/forget-password" class="c_red">Forget Password?</a></div>
				<div class="col-xs-4">
