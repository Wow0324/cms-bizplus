...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="<?php echo base_url().M_REWRITE; ?>admin/coupon/add" class="btn btn-primary btn-sm">Add New</a>
	</div>
</section>
            ...
            <tbody>
            	...
            	foreach ($coupon as $row) {
					...
					<tr>
	                    ...
	                    <td>
	                        <a href="<?php echo base_url().M_REWRITE; ?>admin/coupon/edit/<?php echo safe_data($row['coupon_id']); ?>" class="btn btn-primary btn-xs">Edit</a>
	                        <a href="<?php echo base_url().M_REWRITE; ?>admin/coupon/delete/<?php echo safe_data($row['coupon_id']); ?>" class="btn btn-danger btn-xs" onClick="return confirm('Are you sure?');">Delete</a>
	                    </td>
	                </tr>
            		<?php
            	}
