...
<section class="content-header">
	<div class="content-header-left">
		<h1>Menu Control (Show to Hide)</h1>
	</div>
</section>
			...
			<?php echo form_open_multipart(base_url().'admin/menu',array('class' => 'form-horizontal')); ?>
				<div class="box box-info">
					<div class="box-body">
						...
						{
							?>
							<input type="hidden" name="menu_id[]" value="<?php echo safe_data($row['menu_id']); ?>">
							<div class="form-group">
								<label for="" class="col-sm-2 control-label"><?php echo safe_data($row['menu_name']); ?> </label>
								<div class="col-sm-2">
