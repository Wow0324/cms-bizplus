...
class Photo extends MY_Controller 
{
	...
	public function add()
	{
		...
		$photo_caption = secure_data($this->input->post('photo_caption', true));
		...
		if(isset($_POST['form1'])) {
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().M_REWRITE.'admin/photo');

		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().M_REWRITE.'admin/photo/add');
		    }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().M_REWRITE.'admin/photo/edit'.$id);
		    }
