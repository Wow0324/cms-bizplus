...
class Testimonial extends MY_Controller 
{
	...
	public function add()
	{
		...
		if(isset($_POST['form1'])) {
			...
			$designation = secure_data($this->input->post('designation', true));
		    ...
		    if($valid == 1) 
		    {
				...
				redirect(base_url().M_REWRITE.'admin/testimonial');
		    } 
		    else
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().M_REWRITE.'admin/testimonial/add');
		    }
	...
	public function edit($id)
	{
		...
		if(isset($_POST['form1'])) 
		{
		    ...
		    {
		    	$this->session->set_flashdata('error',$error);
				redirect(base_url().M_REWRITE.'admin/testimonial/edit'.$id);
		    }
