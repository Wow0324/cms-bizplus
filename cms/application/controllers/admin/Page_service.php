...
class Page_service extends MY_Controller 
{
	...
	public function edit($id)
	{
    	...
    	if(!$tot) {
    		redirect(base_url().M_REWRITE.'admin/page-service');
        	exit;
    	}
		...
		if(isset($_POST['form1'])) 
		{
			...
			$service_heading = secure_data($this->input->post('service_heading', true));
		    ...
		    else
		    {
				...
				redirect(base_url().M_REWRITE.'admin/page-service/edit'.$id);
		    }
